...
# Importamos nossos módulos novos
...
class App(Frame):
    def __init__(self, master=None):
        ...
        self.ciclo_manutencao() # Heartbeat e Sync
    ...
    def valida_e_registra(self):
        try:
            # Lógica de conversão Wiegand/Aba
    ...
    def liberar(self, nome):
        ...
        # Notifica a nossa Central sobre o acesso
        comunicacao.notificar_acesso_central(nome, "LIBERADO", parametros.unidade_logica, parametros.ip_central)
